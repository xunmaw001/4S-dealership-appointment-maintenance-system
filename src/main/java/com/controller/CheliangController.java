    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("pinpai_types", cheliang.getPinpaiTypes())
            .eq("cheliang_yanse", cheliang.getCheliangYanse())
            ;
...
//                            cheliangEntity.setCheliangPhoto("");//照片
//                            cheliangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            cheliangEntity.setCheliangTypes(Integer.valueOf(data.get(0)));   //车辆型号 要改的
//                            cheliangEntity.setPinpaiTypes(Integer.valueOf(data.get(0)));   //车辆品牌 要改的
//                            cheliangEntity.setCheliangYanse(data.get(0));                    //车辆颜色 要改的
//                            cheliangEntity.setCheliangTime(new Date(data.get(0)));          //购置时间 要改的
