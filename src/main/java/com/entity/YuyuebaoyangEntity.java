...
public class YuyuebaoyangEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YuyuebaoyangEntity() {

	}

	public YuyuebaoyangEntity(T t) {
		try {
    ...
    public String toString() {
        return "Yuyuebaoyang{" +
            "id=" + id +
            ", yuyuebaoyangTime=" + yuyuebaoyangTime +
            ", yonghuId=" + yonghuId +
            ", cheliangId=" + cheliangId +
            ", yuyuebaoyangTypes=" + yuyuebaoyangTypes +
            ", yuyuebaoyangStatusTypes=" + yuyuebaoyangStatusTypes +
