    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="车辆型号" prop="cheliangTypes">
                        <el-select v-model="ruleForm.cheliangTypes" :disabled="ro.cheliangTypes" placeholder="请选择车辆型号">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="车辆品牌" prop="pinpaiTypes">
                        <el-select v-model="ruleForm.pinpaiTypes" :disabled="ro.pinpaiTypes" placeholder="请选择车辆品牌">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="购置时间" prop="cheliangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.cheliangTime"
                                type="datetime"
                                placeholder="购置时间"
                                :disabled="ro.cheliangTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.cheliangTime" label="购置时间" prop="cheliangTime">
                            <span v-html="ruleForm.cheliangTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
