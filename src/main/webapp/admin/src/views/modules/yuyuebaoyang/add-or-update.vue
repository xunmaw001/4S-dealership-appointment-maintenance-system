    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='cheliang' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.cheliangPhoto" label="车辆图片" prop="cheliangPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.cheliangPhoto" label="车辆图片" prop="cheliangPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='cheliang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车辆型号" prop="cheliangValue">
                        <el-input v-model="cheliangForm.cheliangValue"
                                  placeholder="车辆型号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="车辆型号" prop="cheliangValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='cheliang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="车辆品牌" prop="pinpaiValue">
                        <el-input v-model="cheliangForm.pinpaiValue"
                                  placeholder="车辆品牌" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="车辆品牌" prop="pinpaiValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='cheliang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="购置时间" prop="cheliangTime">
                        <el-input v-model="cheliangForm.cheliangTime"
                                  placeholder="购置时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="购置时间" prop="cheliangTime">
                            <el-input v-model="ruleForm.cheliangTime"
                                      placeholder="购置时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="yuyuebaoyangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.yuyuebaoyangTime"
                                type="date"
                                placeholder="预约时间"
                                :disabled="ro.yuyuebaoyangTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyuebaoyangTime" label="预约时间" prop="yuyuebaoyangTime">
                            <span v-html="ruleForm.yuyuebaoyangTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="cheliangId" name="cheliangId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="保养项目" prop="yuyuebaoyangTypes">
						  <el-select v-model="ruleForm.yuyuebaoyangTypes" multiple placeholder="请选择保养项目">
						    <el-option
						      v-for="item in yuyuebaoyangTypesOptions"
						      :key="item.codeIndex"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="保养项目" prop="yuyuebaoyangValue">
							<el-select disabled v-model="ruleForm.yuyuebaoyangTypes" multiple placeholder="请选择保养项目">
								<el-option
								  v-for="item in yuyuebaoyangTypesOptions"
								  :key="item.codeIndex"
								  :label="item.indexName"
                ...
                <el-col :span="12">
                    <div  v-if="type=='info'">
                        <el-form-item class="input" label="预约状态" prop="yuyuebaoyangStatusValue">
							<el-input v-model="ruleForm.yuyuebaoyangStatusValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yuyuebaoyangTime: false,
                    yonghuId: false,
                    cheliangId: false,
                    yuyuebaoyangTypes: false,
                    yuyuebaoyangStatusTypes: false,
                },
                ruleForm: {
                    yuyuebaoyangTime: '',
                    yonghuId: '',
                    cheliangId: '',
                    yuyuebaoyangTypes: '',
                    yuyuebaoyangStatusTypes: '1',
                },
                yuyuebaoyangTypesOptions : [],
                yuyuebaoyangStatusTypesOptions : [],
                cheliangOptions : [],
                yonghuOptions : [],
                rules: {
                   yuyuebaoyangTime: [
                   ...
                   cheliangId: [
                              { required: true, message: '预约车辆不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyuebaoyang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuyuebaoyangTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyuebaoyang_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuyuebaoyangStatusTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yuyuebaoyang/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
						let temp=[]
						data.data.yuyuebaoyangTypes.split(',').forEach(function(item,index){
							temp.push(Number(item));
						})
						data.data.yuyuebaoyangTypes = temp;
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
						console.log(this.ruleForm.yuyuebaoyangTypes)
						this.ruleForm.yuyuebaoyangTypes = this.ruleForm.yuyuebaoyangTypes.toString()
                        this.$http({
                            url:`yuyuebaoyang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yuyuebaoyangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
